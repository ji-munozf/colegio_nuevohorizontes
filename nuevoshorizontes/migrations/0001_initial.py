# Generated by Django 4.1.3 on 2023-05-30 01:28
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Materia',
            fields=[
                ('id_materia', models.CharField(default='', max_length=6, primary_key=True, serialize=False, verbose_name='ID de la materia')),
                ('nombre_materia', models.CharField(default='', max_length=25)),
            ],
        ),
        migrations.CreateModel(
            name='Noticias',
        ...
        migrations.AddField(
            model_name='asignatura',
            name='nombre_materia',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='nuevoshorizontes.materia', verbose_name='Nombre de la asignatura'),
        ),
        migrations.CreateModel(
            name='Alumno',
            fields=[
