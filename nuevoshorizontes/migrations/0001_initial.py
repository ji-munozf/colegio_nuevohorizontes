# Generated by Django 4.2 on 2023-05-19 00:41
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Curso',
            fields=[
                ('id_curso', models.CharField(max_length=5, primary_key=True, serialize=False, verbose_name='ID del curso')),
        ...
        migrations.CreateModel(
            name='Noticias',
            fields=[
                ('id_noticia', models.IntegerField(primary_key=True, serialize=False, verbose_name='ID de la noticia')),
        ...
        migrations.CreateModel(
            name='Tipo_Sala',
            fields=[
                ('id_tipo_sala', models.IntegerField(primary_key=True, serialize=False, verbose_name='ID tipo sala')),
        ...
        migrations.CreateModel(
            name='Sede',
            fields=[
                ('id_sede', models.IntegerField(primary_key=True, serialize=False, verbose_name='ID sede')),
                ...
                ('comuna_sede', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='nuevoshorizontes.comuna', verbose_name='Comuna')),
            ],
        ),
        migrations.CreateModel(
            name='Sala',
            fields=[
                ...
                ('sede_sala', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='nuevoshorizontes.sede', verbose_name='Sede asignado')),
                ('tipo_sala', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='nuevoshorizontes.tipo_sala', verbose_name='Tipo sala')),
            ],
        ),
        migrations.CreateModel(
            name='Pago',
        ...
        migrations.CreateModel(
            name='Docente',
            fields=[
                ('rut_docente', models.CharField(max_length=12, primary_key=True, serialize=False, verbose_name='Rut')),
                ('id_docente', models.CharField(max_length=15, verbose_name='Id docente')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('horario_bloque', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='nuevoshorizontes.horario', verbose_name='Horario bloque')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='nuevoshorizontes.curso', verbose_name='Curso asignado'),
        ),
        migrations.AddField(
            model_name='asignatura',
